...
public class Languages {
    ...
    public static void chinese(HashMap<String, String> mess) {
        ...
        mess.put("paytoggle_true", "&a你现在接受收款");
        mess.put("paytoggle_false", "&a你现在拒绝收款");
        mess.put("paytoggle_other_true", "&c你设置 %player% 接受收款");
        mess.put("paytoggle_other_false", "&c你设置 %player% 拒绝收款");
    ...
    public static void chinesetw(HashMap<String, String> mess) {
        ...
        mess.put("paytoggle_true", "&a你現在接受轉帳");
        mess.put("paytoggle_false", "&a你現在拒絕轉帳");
        mess.put("paytoggle_other_true", "&c你設置 %player% 接受轉帳");
        mess.put("paytoggle_other_false", "&c你設置 %player% 拒絕轉帳");
